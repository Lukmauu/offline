...
{   
     ...
     * @access public  
     */
    public static function echoPre ( $thing, $flag=false ) {
     ...
     * 
     * @param Array $array
     * @param \stdClass|Boolean|Bar $object
     * @param Boolean $keyNotToLowercase
     * @return \stdClass||Bar
     */
    public static function arrayToObject($array, $object=false, $keyNotToLowercase=false) {
        ...
        foreach ($array as $key => $value) {
            ...
            $object_->{$key_} = is_array($value) ? $this->_arrayToObject($value) : stripslashes(strip_tags(trim($value))); 
        }
    ...
    /**
     * 
     * @param String $String The string to be search on it;
     * @param String $This What to find on the given string
     * @return Boolean If find(true) or not(false)
     * @access public
     */
    public static function findIn($String, $This) {
         return strpos($String, $This);
    }
}